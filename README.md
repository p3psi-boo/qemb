...
# Convert Hugging Face model to packed format (not implemented)
qemb convert --input ./hf-model --output ./model
...
See [docs/plans/2026-03-23-phase1-implementation.md](docs/plans/2026-03-23-phase1-implementation.md) for Phase 1 implementation details.
